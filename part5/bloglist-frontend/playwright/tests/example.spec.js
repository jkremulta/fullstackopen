...
describe('Blog app', () => {
  ...
  describe('When logged in', () => {
    ...
    test('a new blog can be created', async ({ page }) => {
      ...
      const notificationDiv = page.locator('.notification')
      await expect(notificationDiv).toContainText('a new blog How To Play Tchoukball by Joshua Kenta added')
    ...
    // create blog first
      ...
      await page.getByRole('link', { name: 'How To Play Tchoukball' }).click()
